...
Topics I care about (weight the brief toward these):
- AI / LLMs / voice agents
- Startups & tech industry news
- <add your own>

Accounts worth extra attention (quote them when relevant):
- <@handle>
- <@handle>
...
- **My bookmarks** (primary) — brief what I've saved.
...
- (Optional) My home timeline, topic searches, trends, news.
